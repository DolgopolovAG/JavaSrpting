package com.example.lesson4_boot.controller;

//import com.example.lesson4_boot.config.ProductProps;
import com.example.lesson4_boot.model.Product;
import com.example.lesson4_boot.service.ProductService;
...
public class MyController {
    ...
    @GetMapping(path = "/{id}") //http://localhost:8080/spring/product/{id}
